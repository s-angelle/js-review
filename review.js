...
//  console.log(` We are going to print ${otherVariable}.` );
...
// REFERENCE UNICODE CHEATSHEET: https://www.vertex42.com/ExcelTips/unicode-symbols.html
...
// let variable1 = 'Per Scholas';
// console.log(variable1.startsWith('Per'));


// Now use any variable with endsWith() and return false

// console.log(variable1.endsWith('Sholars'));
...
// Doesn't have to be a string. Can be anything. 
...
// console.log(joshIsLookingForWifey.charAt(27));
...
// for (let firstName in lana){
// console.log(lana[firstName])
  
// }

// console.log(firstName, letters) for visualization on what is happening.
...
// perscholas.forEach(element => console.log(element + pS),pS = ' PS'); 
